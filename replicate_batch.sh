...
# ./replicate.sh src/app "app.routes.ts app.config.ts" "10 11 12 13 14"
# ./replicate.sh src/app "provideGraphQL.ts" "10 11 12 13 14"
# ./replicate.sh src/app/auth "auth.graphql.queries.ts auth.graphql.custom.service.ts" "10 11 12 13 14"
# ./replicate.sh src/app "app.component.ts app.component.spec.ts" "8 10 11 12 13 14"
